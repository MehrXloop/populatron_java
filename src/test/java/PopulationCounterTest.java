...
public class PopulationCounterTest {
    ...
    @Test
    public void testGetReadDataMethod() throws Exception {
    ...
    @Test
    public void testGetParseData() throws Exception {
        Parser parser = mock(Parser.class);
        List<String[]> data = new LinkedList<>();
        String[] onerow = { "ad", "aixas", "06", "", "42.4833333", "1.4666667" };
        data.add(onerow);
